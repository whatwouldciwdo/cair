...
for i in {1..60}; do curl -fsS http://127.0.0.1/api/health/ready && break; sleep 5; done
curl -fsS http://127.0.0.1/api/health/ready | tee "evidence/ready-$(date +%Y%m%d-%H%M%S).json"
